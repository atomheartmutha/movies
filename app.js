...
const API_URL = 'http://www.omdbapi.com/?i=tt3896198&apikey=7c097e15';
...
function getMovieTemplate(movie, cols, button = true) {
  ...
  <div class="card col-${cols}">
    ...
    <div class="card-body">
      ...
      ${
        button ?
        `<button onclick="buttonClicked(event)" data-id="${movie.imdbID}" type="button" class="btn btn-danger favorite-button">Favorite</button>`
        : ''
      }
    </div>
  </div>
